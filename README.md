...
```groovy
// Add the following code to the root build.gradle.kts.kts file of your project
allprojects {
    repositories {
        maven { url "https://jitpack.io" }
    }
}
// Add the following code to the build.gradle.kts.kts file of your app module
dependencies {
